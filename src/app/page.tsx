...
export default function Home() {
  return (
    <>
      ...
      <Section bgColor="white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-card p-6 text-center">
            ...
            <h3 className="feature-title text-xl mb-2">Trusted & Professional</h3>
            <p className="feature-description">With years of experience, we deliver exceptional results that keep our customers coming back.</p>
          </div>
          ...
          <div className="feature-card p-6 text-center">
            ...
            <h3 className="feature-title text-xl mb-2">Eco-Friendly Solutions</h3>
            <p className="feature-description">We use green cleaning products that are safe for your family, pets, and the environment.</p>
          </div>
          ...
          <div className="feature-card p-6 text-center">
            ...
            <h3 className="feature-title text-xl mb-2">Fast & Efficient</h3>
            <p className="feature-description">Our efficient process minimizes disruption to your home or business with quick dry times.</p>
          </div>
        </div>
      </Section>

      {/* About Preview Section */}
      <Section bgColor="secondary" title="About CarpetCozy" subtitle="We're committed to providing the highest quality carpet cleaning services in Roseville and surrounding areas." className="about-section">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="mb-6 text-foreground">
              At <span className="carpet-text">Carpet</span><span className="cozy-text">Cozy</span>, we believe that clean carpets make for a healthier, more comfortable home. Founded with a passion for cleanliness and customer satisfaction, we've been serving the Roseville area for years with professional carpet cleaning services.
            </p>
            <p className="mb-6 text-foreground">
      ...
      <Section title="Our Services" subtitle="We offer a range of professional carpet cleaning services to meet your needs." className="text-foreground">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-[var(--accent)] to-[#006666] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-shadow">Ready for Cleaner, Fresher Carpets?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Contact us today for a free quote and experience the <span className="carpet-text">Carpet</span><span className="cozy-text">Cozy</span> difference!
          </p>
          <Button 
            href="/contact" 
            className="bg-white text-[var(--accent)] hover:bg-gray-100"
            size="lg"
            icon={
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
