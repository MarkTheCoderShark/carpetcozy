...
export const metadata = {
  title: "Auburn Commercial Carpet Cleaning | Office & Retail | CarpetCozy",
  description: "Professional commercial carpet cleaning services in Auburn, CA. We clean offices, retail spaces, and businesses. Flexible scheduling available!",
  keywords: "commercial carpet cleaning Auburn, office carpet cleaning Auburn, commercial floor cleaning Auburn, business carpet cleaning Auburn, retail carpet cleaning Auburn",
};

export default function AuburnCommercialCarpetCleaningPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-[50vh] min-h-[400px] bg-gray-800 text-white flex items-center"> {/* Neutral dark color */}
        <div className="absolute inset-0 z-0">
          ...
          <div className="relative h-full">
            <Image 
              ...
              alt="Commercial carpet cleaning for offices and businesses in Auburn, CA" 
              fill
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Auburn Commercial Carpet Cleaning</h1>
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Maintain a professional image with reliable carpet cleaning for your Auburn business.
          </p>
      ...
      <Section title="Professional Carpet Care for Auburn Businesses">
        <div className="max-w-4xl mx-auto text-lg">
          <p className="mb-6">
            First impressions matter. Ensure your Auburn business always looks its best with commercial carpet cleaning services from CarpetCozy. We provide reliable, high-quality carpet care for offices, retail stores, restaurants, and other commercial properties throughout Auburn.
          </p>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-bold mb-4 text-blue-700">Why Auburn Businesses Choose CarpetCozy:</h3>
      ...
      <section className="bg-gradient-to-r from-gray-700 to-gray-900 text-white py-16"> {/* Neutral dark color */}
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Keep Your Auburn Business Looking Sharp!</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Contact CarpetCozy today for a free, no-obligation quote for your commercial carpet cleaning needs in Auburn.
          </p>
          <Button 
            href="/contact" 
