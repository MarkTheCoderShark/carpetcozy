...
export const metadata = {
  title: "Emergency Water Extraction Roseville | 24/7 Service | CarpetCozy",
  description: "Fast emergency water extraction and carpet drying services in Roseville, CA. 24/7 response for water damage cleanup in homes and businesses. Call now!",
  keywords: "emergency water extraction Roseville, emergency carpet drying Roseville, water damage cleanup Roseville, flood cleanup Roseville, 24/7 water extraction Roseville",
};

export default function RosevilleWaterExtractionPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-[50vh] min-h-[400px] bg-red-800 text-white flex items-center"> {/* Red for urgency */}
        <div className="absolute inset-0 z-0">
          ...
          <div className="relative h-full">
            ...
            <Image 
              ...
              alt="Emergency water extraction services in Roseville, CA" 
              fill
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Emergency Water Extraction in Roseville</h1>
          <p className="text-2xl font-semibold mb-4">Available 24/7 - Call Us Immediately!</p> {/* Add phone number if available */}
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Fast response for water damage emergencies in Roseville homes and businesses. We minimize damage and dry your carpets quickly.
          </p>
      ...
      <Section title="Rapid Water Removal & Drying in Roseville">
        <div className="max-w-4xl mx-auto text-lg">
          <p className="mb-6">
            Water damage requires immediate action to prevent further issues like mold growth and structural damage. CarpetCozy offers <strong className="font-semibold">24/7 emergency water extraction</strong> and drying services for homes and businesses throughout Roseville, CA.
          </p>
          <p className="mb-6">
            Whether you've experienced a burst pipe, appliance leak, or flooding, our rapid response team is ready to help. We arrive quickly with powerful extraction equipment to remove standing water from your carpets and affected areas. Our process is designed to mitigate damage and begin the drying process as soon as possible.
          </p>
          <h3 className="text-2xl font-bold mb-4 text-red-700">Our Roseville Emergency Water Extraction Services:</h3>
          <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700">
            <li><strong className="font-semibold">24/7 Emergency Response:</strong> We're available day or night for water damage emergencies in Roseville.</li>
          ...
          <p className="mb-6 font-semibold text-red-600">
            If you have a water emergency in Roseville, don't wait! Call CarpetCozy immediately to minimize damage.
          </p>
      ...
      <section className="bg-gradient-to-r from-red-700 to-red-900 text-white py-16"> {/* Red for urgency */}
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Water Damage Emergency in Roseville?</h2>
