...
export default function RocklinCarpetCleaningPage() {
  return (
    <>
      ...
      <Section title="Your Trusted Carpet Cleaners in Rocklin">
        <div className="max-w-4xl mx-auto text-lg">
          <p className="mb-6">
            CarpetCozy provides top-rated professional carpet cleaning services across Rocklin, CA. Our expert technicians are equipped to handle all your carpet cleaning needs, ensuring your home or business looks its best.
          </p>
          <p className="mb-6">
            We use advanced hot water extraction (steam cleaning) methods and eco-friendly solutions to deep clean your carpets, removing dirt, allergens, stains, and odors effectively. Our goal is to leave your carpets looking and feeling fresh, extending their lifespan and improving your home's air quality in Rocklin.
          </p>
          <h3 className="text-2xl font-bold mb-4 text-blue-700">Why Choose CarpetCozy in Rocklin?</h3>
          ...
          <div className="text-center mt-8">
             <Button href="/contact" variant="primary" size="lg">Schedule Your Rocklin Cleaning</Button>
          </div>
        </div>
      </Section>
