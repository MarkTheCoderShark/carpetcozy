...
export const metadata = {
  title: "Commercial Tile & Grout Cleaning in Folsom | CarpetCozy",
  description: "Expert commercial tile and grout cleaning for Folsom businesses, restaurants, medical facilities & gyms. Professional, reliable service from CarpetCozy.",
  keywords: "commercial tile cleaning Folsom, restaurant tile cleaning Folsom, gym floor cleaning Folsom, grout cleaning Folsom, tile cleaning Folsom CA, CarpetCozy",
};

export default function FolsomCommercialTileServicePage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "Commercial Tile and Grout Cleaning in Folsom",
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-text-primary">
            Commercial Tile Cleaning in Folsom
          </h1>
      ...
      <Section title="Specialized Commercial Tile Cleaning in Folsom" subtitle="Keep your Folsom business floors pristine and hygienic">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
             <h3 className="text-2xl font-bold mb-4">Expert Solutions for Folsom Businesses</h3>
            <p className="text-text-primary/80 mb-4">
              Folsom's commercial spaces, from restaurants on East Bidwell Street to medical facilities near Mercy Hospital, require specialized tile and grout cleaning to maintain hygiene standards and appearance. CarpetCozy provides industry-leading commercial tile cleaning services tailored to the unique demands of high-traffic, spill-prone environments throughout Folsom.
            </p>
            ...
            <h4 className="text-xl font-semibold mb-3">Benefits for Your Folsom Business:</h4>
            ...
            <Button href="/contact?service=commercial-tile&location=folsom" className="mr-4">Request a Quote</Button>
          ...
          <div className="relative h-80 rounded-lg overflow-hidden shadow-md order-1 md:order-2">
            <img 
              src="/images/tile.jpg"
              alt="Professional tile cleaning in a Folsom commercial space" 
      ...
      <Section title="Industry-Specific Solutions for Folsom Businesses" bgColor="alt">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-3 text-text-primary">Restaurant & Food Service</h3>
            <p className="text-text-primary/80 mb-4">
              Folsom's restaurants and food service businesses face unique challenges with food spills, grease, and constant foot traffic. Our specialized cleaning removes tough stains while maintaining a safe, hygienic environment for your staff and customers.
            </p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <p className="text-text-primary/80 mb-4">
              Folsom's fitness centers require specialized cleaning to handle heavy foot traffic, sweat, and equipment impact. Our sanitizing process maintains a clean, motivating environment for your members.
            </p>
            <ul className="list-disc list-inside space-y-1 text-text-primary/80 mb-4">
      ...
      {/* Our Process */}
      <Section title="Our Commercial Tile Cleaning Process in Folsom">
        <div className="space-y-8 max-w-3xl mx-auto">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-text-primary/80">We begin with a thorough evaluation of your Folsom commercial space, identifying high-traffic areas, stains, and specific cleaning challenges. This allows us to create a customized cleaning plan that addresses your unique needs.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-text-primary/80">We conduct a thorough inspection to ensure all areas meet our quality standards. We'll also provide recommendations for ongoing maintenance to keep your Folsom business's tile surfaces looking their best between professional cleanings.</p>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section bgColor="dark" textColor="light">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Spotless Commercial Floors in Folsom?</h2>
          ...
          <Button href="/contact?service=commercial-tile&location=folsom" variant="secondary" size="lg" className="text-text-primary bg-background hover:bg-background/90">
